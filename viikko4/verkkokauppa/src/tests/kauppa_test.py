...
class TestKauppa(unittest.TestCase):
    ...
    def test_ostetaan_kaksi_erillaista_tuotetta(self):
        viitegeneraattori_mock = Mock()
    ...
    def test_aina_uusi_viitenumero(self):
        ...
        viitegeneraattori_mock.uusi.side_effect = [1, 2, 3, 4, 5]
        ...
        # varmistetaan, että metodia tilisiirto on kutsuttu oikeilla parametreilla
        self.pankki_mock.tilisiirto.assert_called_with("pekka", 2, "12345", ANY, 3)
    ...
    def test_poista_korista(self):
        ...
        self.pankki_mock.tilisiirto.assert_called_with("pekka", 1, "12345", ANY, 3)